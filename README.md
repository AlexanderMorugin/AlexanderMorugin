...
<ul>
    ...
    <li><b><a href="https://github.com/AlexanderMorugin/vue-xwear">Проект функциональной шапки для сайта</a></b> - Приложение выполнено на Vue 3, без использования дополнительных библиотек.<br>Адаптивная верстка, БЭМ-нейминг классов, плавные анимации при наведении.<br>Интересные выпадающие меню с технологией возврата, в десктопе и мобильной версиях.<br>Бекэнд не используется, все на моковых данных.<br>Смотреть работу: https://vela-vue.vercel.app/<br><br>
    </li>
</ul>
